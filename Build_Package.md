...
The original adapter cable stays entirely inside and plugs directly into the logger. Dress its slack using the reserved DC tie location; do not crush the flat jacket. Cable curves are illustrative: actual length, bend allowance, mains separation and lid clearance need dry fitting. No XA, DC or USB wall opening remains.

USB configuration/download is temporary, with mains unplugged and verified absent. Remove USB and close the opaque cover before operation. Validate saved records with an offline download after a supervised pilot; the opaque cover hides the logger LEDs. Check adapter/enclosure temperature in that pilot.
...
The six anchor positions support the mains bundle, outlet supply, CT pair, two sides of the voltage-lead coils and the original internal DC cable. Each tie passes through its mounting-base slot and encloses that bundle. The same coordinates drive the panel CAD and 3D view.
...
| Three WAGO carriers | 6 × M3 × 16 mm pan screws; 6 × M3 washers; 6 × M3 locknuts | Buy 8 each: [screws, 6835](https://boltdepot.com/Product-Details?product=6835), [washers, 4513](https://boltdepot.com/Product-Details?product=4513), [nuts, 4792](https://boltdepot.com/Product-Details?product=4792). |
...
| Stock unavailable / designer | Reuse result ___; fallback decision ___ | A [Hammond 14R1513 panel](https://www.digikey.com/en/products/detail/hammond-manufacturing/14R1513/2359585), previously priced $30.44, is the documented fallback. Recheck its price and fit if needed; it is not included in the active $261.26 budget or a claim of aluminum reuse. |
