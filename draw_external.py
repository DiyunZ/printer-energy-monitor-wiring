...
def draw_external(add,rect,text,line,circle,C):
    ...
    rect(1350,642,400,240,'#f3f6f8','#aebdca',12);text(1374,678,'Box face · conceptual layout',19,weight=700)
    rect(1380,710,80,95,'#fff','#8c9ba8',6);rect(1400,735,40,45,'#273440','#273440',3);text(1420,832,'Q0',18,weight=700,anchor='middle')
    rect(1510,710,200,135,'#fff','#8c9ba8',7)
    for x in [1570,1630]:rect(x,737,9,30,'#273440','#273440',1)
    circle(1605,796,9,'#273440','#273440');text(1610,835,'XA · ADAPTER ONLY',15,weight=700,anchor='middle')
