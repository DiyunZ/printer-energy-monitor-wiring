...
Three WAGO **221-415 / 221-505** connector/carrier pairs provide JL, JN and PE. A1 connects to JL after Q0; A2 and A3 connect to JN. PE connects supply earth, printer earth, XA ground and the panel bond, leaving one spare port. One accepted conductor per port; neutral and PE remain separate.
...
Retain all factory panel and lid features. The panel now has 11 new cut features: six cable-anchor holes, one dedicated panel PE hole and four strap slots. Transfer-drill six additional holes for the three carriers. Deburr every cut, remove chips and protect the gasket. Smooth strap slots on both faces without enlarging their functional opening. Machining does not confer an IP/NEMA certification on the completed assembly.
...
Use the selected 14 AWG black / white / green internal wire. The following are conservative **cutting blanks**, not proved finished lengths; final routing, bends and stripping are done with the assembly de-energized. Allow 3 m black, 2 m white and 3 m green including spare wire (linked retail rolls exceed these needs).
...
3. Install and secure the panel **before XA**. The digital insertion sweep shows that the installed right-side outlet obstructs the straight panel path. Fit the three carriers, meter and CT. Leave access to the CT latch and WAGO levers.
